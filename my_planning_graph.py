...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a):
        ...
        a1 = node_a1.action
        a2 = node_a2.action
        for clause in a1.effect_add:
            if clause in a2.effect_rem:
                return True
        for clause in a1.effect_rem:
            if clause in a2.effect_add:
                return True
        return False
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a):
        ...
        a2 = node_a2.action
        for clause in a1.effect_add:
            if clause in a2.precond_neg:
                return True
        for clause in a1.effect_rem:
            if clause in a2.precond_pos:
                return True
        for clause in a2.effect_add:
            if clause in a1.precond_neg:
                return True
        for clause in a2.effect_rem:
            if clause in a1.precond_pos:
                return True
        return False
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a):
        ...
        for state_node_1 in node_a1.parents:
            for state_node_2 in node_a2.parents:
                if state_node_1 in state_node_2.mutex or state_node_2 in state_node_1.mutex:
                    return True
        return False
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        for a_node_1 in node_s1.parents:
            for a_node_2 in node_s2.parents:
                if not (a_node_1.is_mutex(a_node_2) or a_node_2.is_mutex(a_node_1)):
